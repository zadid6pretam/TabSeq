...
and a classification model. Users can tune parameters to optimize performance for their datasets.
...
File Name:
TabSeq_BinaryClassification.py
...
#     - Depending on the classification task, consider using different loss functions (e.g., focal loss for imbalanced data) or metrics.
...
# Calculate AUC
test_auc = roc_auc_score(y_test_5, y_test_pred_proba)
